...
/**
* Wrapper for `hadoop jar` shell command
*
*/
class HadoopWrapper
{
    /** @var \Closure Callback which accepts one argument: \MapReduce\Cli\Response */
    ...
    */
    public function exec ()
    {
        ...
        $result->command = "hadoop jar ". implode(' ', $args);
